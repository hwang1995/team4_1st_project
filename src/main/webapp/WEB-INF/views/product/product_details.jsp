...
<!-- 상품 상세 페이지 레이아웃 불러오기-->
<link rel="stylesheet"
	href="${resources}/css/layout/item_details_layout.css">
	...
	<section>
		<article>
			<div class="container-xl item_details_container">
				<div class="row">
					<div id="carousel" class="carousel slide col-12 col-md-6 mt-3"
						data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="${product.product_image}" class="d-block w-100" alt="product" width="100%">
							</div>
							<c:forEach var="product"
								items="${product.product_imgs_carousel_list }">
								<div class="carousel-item">
									<img src="${product.product_img_name }" class="d-block w-100" alt="..." width="100%">
								</div>
							</c:forEach>
						</div>
					...
					<div class="col-12 col-md-6 mt-3">
						<div class="item_description">
							...
							<div class="d-md-block d-none">
								...
								<h6 class="mt-3">${fn:replace(product.product_subcontent, replaceChar, "<br/>")}
								</h6>
								<h6 class="mt-3">${fn:replace(product.product_content, replaceChar, "<br/>")}
								</h6>
							</div>

							<!-- 해상도 조건이 md(768 px) 이하인 경우 나오는 레이아웃 -->
							<div
								class="d-md-none d-block mt-4 d-flex flex-column justify-content-center">
							...
							<div class="row">
								<div class="col mt-3">
									...
									<select name="color" class="select_item mt-2 p-1" id="color_select">
										...
										<c:forEach var="product"
											items="${product.product_colors_list}">
                            ...
                            <div class="row">
                                ...
                                <div class="col mt-3">
                                    ...
                                    <div class="item_details_quantity d-flex mt-2">
                                        ...
                                        <input type="text" class="item_details_quantity_status eng_h3" value=1 readonly>
                                        <div class="item_details_plus ml-3 mr-2 d-flex align-items-center">
                                            <img src="${resources}/svg/plus.svg" alt="plus" width="24px">
                                        </div>
                                    </div>
